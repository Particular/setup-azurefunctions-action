...
$storage = az storage account create --name $StorageName --location $region --resource-group $resourceGroup --sku Standard_LRS --min-tls-version TLS1_2 --tags $packageTag $runnerOsTag $dateTag | ConvertFrom-Json
if (-not $?) {
