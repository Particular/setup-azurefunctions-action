...
This action handles the setup and teardown of an Azure Functions app for running tests.

> [!WARNING]
> TODO: Remainder of this file is a copy from the Azure Service Bus action
